...
public class GraficoEsercizio {
	...
	//COSTRUTTORE
	public GraficoEsercizio(ActionEvent e)
	{
		c = Main.getC();
		try {
			radice = FXMLLoader.load(getClass().getResource("graficoEsercizio.fxml"));
	...
	private void fillChart()
	{
		...
		c.sendMsg("@@@#");
		c.sendMsg(Integer.toString((int) w.getUserData()));
		//ricevo dati 
